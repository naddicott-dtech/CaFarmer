...
export const crops = [
    ...
    { // Corn: Kept harvestValue 75, growthTime 90 for now
        id: 'corn', name: 'Corn', waterUse: 3.5, growthTime: 90, harvestValue: 75, color: '#ffd700',
        soilImpact: -2, fertilizerNeed: 80, basePrice: 75, waterSensitivity: 1.1, heatSensitivity: 0.8
    },
    { // Lettuce: Reduced growthTime
        id: 'lettuce', name: 'Lettuce', waterUse: 1.5, growthTime: 50, harvestValue: 120, color: '#90ee90', // Reduced growthTime from 60
        soilImpact: -1, fertilizerNeed: 60, basePrice: 120, waterSensitivity: 1.2, heatSensitivity: 1.3
    },
    { // Almonds: No change yet
        id: 'almonds', name: 'Almonds', waterUse: 4.5, growthTime: 240, harvestValue: 450, color: '#8b4513',
        soilImpact: -1, fertilizerNeed: 100, basePrice: 450, waterSensitivity: 0.9, heatSensitivity: 0.7
    },
    { // Strawberries: Reduced growthTime
        id: 'strawberries', name: 'Strawberries', waterUse: 2.5, growthTime: 60, harvestValue: 300, color: '#ff6b6b', // Reduced growthTime from 70
        soilImpact: -2, fertilizerNeed: 90, basePrice: 300, waterSensitivity: 1.0, heatSensitivity: 1.1
    },
    { // Grapes: No change yet
        id: 'grapes', name: 'Grapes', waterUse: 3.0, growthTime: 180, harvestValue: 350, color: '#9370db',
